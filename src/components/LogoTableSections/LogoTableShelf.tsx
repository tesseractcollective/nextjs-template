...
export default function LogoTableShelf({ logoTableItems }: LogoTableProps) {
  return (
    <div className="logo-table-grid">
      <section className="container mx-auto px-4">
        <div className="py-12">
          <div className="mx-auto max-w-8xl px-6 lg:px-8">
            <div className="-mx-6 grid grid-cols-1 gap-0.5 overflow-hidden sm:mx-0 sm:rounded-2xl md:grid-cols-2 border border-bg-secondary">
              {logoTableItems.map((logoTableItem) => (
                <div
                  className="logo-grid-item p-8 sm:p-10"
