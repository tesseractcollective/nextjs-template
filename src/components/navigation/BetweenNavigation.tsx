...
export default function BetweenNavigation({
  navigations,
  siteLibrary,
  hideNav,
              ...
              <div className="mx-auto max-w-12xl px-4 sm:px-6 lg:px-8">
                <div className="">
                  ...
                  >
                    ...
                    <Link
                      href="/"
                      className="lg:hidden mr-auto cursor-pointer max-w-[200px]"
                      id="nav-logo-mobile"
                      onClick={() => {
                        ReactGA.event({
                          category: "Link",
                    ...
                    >
                      {navigation?.navigationLogo ? (
                        <>
                          ...
                          <Fade direction="down" triggerOnce>
                            <Image
                              className={`w-full max-w-xs mx-auto cursor-pointer object-contain transition-all p-2 ${
                                small ? "h-10" : "h-20"
                              }`}
                              src={navigation.navigationLogo?.url}
                              alt=""
                    ...
                    <div className="flex flex-1 items-center justify-end max-w-max gap-x-2">
                      ...
                      {primaryItems.map((mainNavigationItem) => (
                        <LinkItem
                          ...
                          link={mainNavigationItem?.link}
                          label={mainNavigationItem?.label}
                          cssClass={`drop-shadow-button-primary font-bold ${mainNavigationItem?.cssClass}`}
                          sameTab={mainNavigationItem?.sameTab}
                        />
                      ))}
                    </div>
