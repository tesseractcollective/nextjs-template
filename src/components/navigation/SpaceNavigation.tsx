            ...
            <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8 w-full">
              ...
              >
                ...
                <Popover.Group
                  ...
                  } transition-all inset-x-0 bottom-0 z-[0] flex flex-row items-center justify-between w-full max-w-max mr-auto`}
                >
                ...
                <div
                  className={`ml-auto hidden h-full md:flex flex-row items-center justify-end gap-x-4 ${
                    small
                      ? "h-0 opacity-0 translate-y-60 blur-sm"
                      : "h-full opacity-1 translate-y-0 blur-0"
                  } transition-all`}
                    ...
                    <div className="flex items-center justify-center max-w-max">
                      {primaryItems.map((mainNavigationItem) => (
                        <LinkItem
                          ...
                          link={mainNavigationItem?.link}
                          label={mainNavigationItem?.label}
                          cssClass={`flex justify-center  items-center font-bold text-text-overlay opacity-90 hover:text-text-color hover:opacity-100 border-1 border-primary cursor-pointer bg-primary px-2 md:px-4 hover:rounded-xl transition-all uppercase my-auto ${
                            mainNavigationItem?.cssClass
                          } ${
                            small
