...
const SpotifyDisplayAll: React.FC<SpotifyDataProps> = ({
  spotifyAlbumsData,
}) => {
                  ...
                  {album.external_urls.spotify && (
                    ...
                    >
                      <FontAwesomeIcon
                        ...
                        className="fa-fw h-5 w-5 flex aspect-1 absolute z-40 text-text-color transition-all group-hover:text-[#52ce52] bottom-2 left-2"
                      />
                      <Image
                        sizes="100%"
...
export default SpotifyDisplayAll;
