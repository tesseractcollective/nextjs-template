...
export default function FixedSideLink({ fixedSideLink }: FixedSideLinkProps) {
  return (
    <div className="fixed right-[-90px] top-[60%] -translate-y-1/2 z-[750] transform -rotate-90">
      <LinkItem
        link={fixedSideLink.link}
        cssClass="relative flex items-center transition-all duration-300 text-text-color !m-0 text-lg uppercase tracking-widest px-6 bg-[#000000b0] hover:bg-primary border-primarary border-x border-t pt-2 pb-7 whitespace-nowrap group font-bold"
      >
        <>
