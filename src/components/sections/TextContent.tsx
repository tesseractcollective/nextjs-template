...
import type { CallToActionFieldsFragment, TextContentFieldsFragment } from "@/graphql/generated/graphql";
...
export default function TextContentSection({
  ...
  console.log("TextContentSection.tsx", textContentData);
  return (
    <>
      {!!textContentData &&
        textContentData.length >= 1 && (
          <>
                      ...
                      <div>
                        {textContentItem?.contentImage && (
                          <Fade direction="up" triggerOnce>
                            ...
                            <LinkItem link={textContentItem.link} cssClass="max-w-max inline-block mx-auto">
                             <Image
