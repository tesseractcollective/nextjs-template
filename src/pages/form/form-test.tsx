...
const FormTest = () => {
  ...
  return (
    <>
      ...
      <div className="hidden col-span-2 h-256 opacity-0 bg-white xl:w-12/12 italic  -mt-52 text-8xl rounded-r-lg -ml-24 top-0 py-12 whitespace-nowrap -bottom-60 flex-col-reverse max-w-sm gap-y-16 z-0 border-t border-primary border"></div>
    </>
  );
};
