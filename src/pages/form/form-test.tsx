...
const FormTest = () => {
  ...
  return (
    <>
      ...
      <div className="hidden col-span-2 h-256 opacity-0 bg-white xl:w-12/12 italic  -mt-52 text-8xl rounded-r-lg -ml-24 -bottom-60 flex-col-reverse gap-y-16 max-w-6xl whitespace-nowrap border-text-overlay rounded-t-4xl rounded-b-4xl"></div>
